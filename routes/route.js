...
import {signupUser ,loginUser,getUserById,getAllUser}from "../controller/userController.js";
import { uploadImage,getImage } from "../controller/image-controller.js";
import { createPost,getAllPosts,getPost,updatePost,deletePost} from "../controller/post-controller.js";

import { orderBurger,getBurger,getBurgerWithCustomer } from "../controller/order-controller.js";
...
router.post('/order',authenticateToken,orderBurger)
router.get('/get-order/:userId',authenticateToken,getBurger)
router.get('/get-order-customer',authenticateToken,getBurgerWithCustomer)
